...
function atan7to8numer(x::DD)
    DD(2.5668496663917798e-16, 1.651452916111978e-32) +
    (DD(0.9387151324182792, -3.0270717177161876e-17) +
    (DD(0.3587599327321039, -1.7392872290704575e-17) +
    (DD(1.030625782506494, -4.848053728687879e-17) +
    (DD(0.2859340551638412, -7.148611182407598e-18) +
    (DD(0.22150394750762553, -2.1083387559551222e-19) +
    DD(0.02616571270868662, 1.638245376595532e-18)*x) *x)*x)*x)*x)*x
end
function atan7to8denom(x::DD)
    DD(0.9387151324183078, -3.683518606033476e-17) +
    (DD(0.35875993273062917, 2.306531245823413e-17) +
    (DD(1.343530826692338, 7.646909676840305e-17) +
    (DD(0.40552069841162863, 2.5606959509250654e-17) +
    (DD(0.4816045453016497, 1.2695153995084683e-17) +
    (DD(0.089587116420656, -2.928431044369765e-18) +
    DD(0.02593235143462814, 3.3989778505381737e-19)*x) *x)*x)*x)*x)*x
end
@inline atan7to8of64(x::DD) = atan7to8numer(x) / atan7to8denom(x)

function atan8to9numer(x::DD)
   DD(1.2714356859656969e-15, 5.34100711196651e-32) +
   (DD(0.9221473103429332, -6.791436377532343e-18) +
   (DD(.39902936044967635, -2.5914569706942505e-17) +
   (DD(1.0300162846836978, 1.2178648094327658e-17) +
   (DD(.3201933652642517, 9.371314522156532e-18) +
   (DD(.2271305449051261, -1.0791712796289499e-17) +
   DD(0.29700799560355852e-1, 7.518263423612489e-19)*x) *x)*x)*x)*x)*x
end
function atan8to9denom(x::DD)
   DD(.9221473103430584, -2.0046418626629893e-17) +
   (DD(.3990293604439834, 9.981209958319761e-18) +
   (DD(1.3373987216229066, -3.0106541068948753e-17) +
   (DD(.45320314908172843, 2.0445919138786005e-17) +
   (DD(.48850069759172504, 2.4536460038334615e-17) +
   (DD(.1009622310270185, 3.3306090520442875e-18) +
   DD(0.2709227320985256e-1, -5.210090811060699e-19)*x) *x)*x)*x)*x)*x
end
@inline atan8to9of64(x::DD) = atan8to9numer(x) / atan8to9denom(x)
