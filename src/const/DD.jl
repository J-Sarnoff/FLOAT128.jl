...
const dd_m1 = dd_one #
const dd_m2 = DD(1.618033988749895, -5.432115203682506e-17);   # 2*cos(6*pi/30)
const dd_m3 = DD(1.9890437907365466, 9.412268501018369e-17);   # 2*cos(1*pi/30)
const dd_m4 = DD(2.4048671723720654, -2.784713129158387e-17);  # 4*cos(6*pi/30)^1*cos(7*pi/30)
const dd_m5 = DD(2.9562952014676114, -1.0180875595367839e-16); # 4*cos(6*pi/30)^1*cos(4*pi/30)
const dd_m6 = DD(3.2183404585236657, 8.214505539497986e-17);   # 4*cos(6*pi/30)^1*cos(1*pi/30)
const dd_m7 = DD(3.891156823326854, -4.6052918114673036e-17);  # 8*cos(6*pi/30)^2*cos(7*pi/30)
const dd_m8 = DD(4.783386116752813, 1.7804205358207684e-16);   # 8*cos(6*pi/30)^2*cos(4*pi/30)
const dd_m9 = DD(5.207384249260213, -2.6782146944489905e-16);  # 8*cos(6*pi/30)^2*cos(1*pi/30)
=#
